...
img_to_detect = cv2.imread('img_test/test_beansprout.jpg')
...
class_labels = ['scallop', 'eggplant', 'crabstick', 'sweetpotato', 'mackerel', 'chili', 'gochujang', 'greenolive', 'koreangim', 
            ...
            'mungbeansprout', 'slicecheese', 'spinach', 'avocado', 'squash', 'onion', 'cucumber', 'squid']
...
yolo_model = cv2.dnn.readNetFromDarknet('./predict_73_classes/yolov4_new_64_8.cfg', './predict_73_classes/weights/yolov4_new_64_8_best_70p_37000.weights')
