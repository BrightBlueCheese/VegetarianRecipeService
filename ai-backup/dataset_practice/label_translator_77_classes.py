...
translated_dict = {'scallop': '가리비', 'eggplant': '가지', 'crabstick': '게맛살', 'sweetpotato': '고구마', 'mackerel': '고등어', 
                ...
                'apple': '사과', 'blueberry': '블루베리', 'walnut': '호두', 'beansprout': '콩나물'}

kor_labeler = {'가리비': 0, '가지': 1, '게맛살': 2, '고구마': 3, '고등어': 4, '고추': 5, '고추장': 6, '그린올리브': 7, '김': 8, 
            ...
            '아몬드':73, '사과':74, '블루베리': 75, '호두': 76, '콩나물':77}


predicted_set_list = ['mungbeansprout', 'tomato']
