...
img_to_detect = cv2.imread('img_test/test_bellpepper.jpg')
...
# only single label 
class_labels = ["Paprika", "BellPepper", "RomaineLettuce"]
...
yolo_model = cv2.dnn.readNetFromDarknetyolo_model = cv2.dnn.readNetFromDarknet('yolov4_new.cfg', 'yolov4_new_best_3c_94.weights')
