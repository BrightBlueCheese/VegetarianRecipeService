...
img_to_detect = cv2.imread('img_test/test_mackerel.jpg')
...
# yolo_model = cv2.dnn.readNetFromDarknet('./predict_77_classes/yolov4-csp-swish_64_32.cfg', './predict_77_classes/weights/yolov4-csp-swish_64_32_best_77p_33000.weights')
yolo_model = cv2.dnn.readNetFromDarknet('./predict_77_classes/yolov4-csp-swish_64_32.cfg', './predict_77_classes/weights/yolov4-csp-swish_64_32_best.weights')
...
max_value_ids = cv2.dnn.NMSBoxes(boxes_list, confidences_list, 0.1, 0.5)
...
############## NMS Change 3 END ########### 
    ...
    cv2.putText(img_to_detect, predicted_class_label_msg, (start_x_pt, start_y_pt-5), cv2.FONT_HERSHEY_SIMPLEX, 2, box_color, 2)
