...
import numpy as  np
import cv2
from dataset_practice import label_translator_65_classes as lt
...
parser.add_argument('-j', '--json', metavar='', type=str, required=True, help='Json path to be saved')
...
# old
yolo_model = cv2.dnn.readNetFromDarknet('./predict_65_classes/yolov4-tiny_65_classes_64_4.cfg', './predict_65_classes/tiny_weights/yolov4-tiny_64_4_last_81300.weights')
